...
async function importC5Data() {
  console.log('═══ C5 Data Import ═══\n');
  ...
  verifyData.slice(0, 5).forEach(r => {
    ...
    console.log(`  ${period} | RA1: ${r.ra1} | RA4: ${r.ra4} | RA9: ${r.ra9} | Total: ${r.ro_total}`);
  });
  ...
  console.log(`Total Responsible/Approved Officers: ${latest.ro_total?.toLocaleString()}`);
