...
Generated by AI Shake-Up Analyzer`;
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-gray-900 to-teal-900 rounded-2xl border border-teal-400/30 w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
        
        {/* Header */}
        <div className="bg-gradient-to-r from-teal-600/20 to-blue-600/20 p-6 border-b border-teal-400/30">
              ...
              {analysisReport && (
                <>
                  <select
                    ...
                    className="bg-gray-800/10 border border-white/20 rounded-lg px-3 py-2 text-white text-sm"
                  >
        ...
        {analysisReport && (
          <>
            {/* Tab Navigation */}
            <div className="bg-gray-800/5 border-b border-teal-400/20">
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${activeTab === tab.id 
                          ? 'text-purple-300 border-b-2 border-teal-400 bg-teal-600/10' 
            ...
            <div className="p-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
              ...
              {activeTab === 'overview' && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-r from-teal-600/20 to-pink-600/20 p-6 rounded-xl border border-teal-400/30">
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2">
                        <div 
                          className="bg-gradient-to-r from-teal-500 to-pink-500 h-2 rounded-full transition-all duration-1000"
                ...
                <div className="space-y-6">
                  ...
                  {analysisReport.shakeUpRecommendations.map((rec, idx) => (
                    ...
                    `}>
                      ...
                      <div className="bg-gray-800/5 p-4 rounded-lg mb-4">
                        <h5 className="font-bold text-purple-300 mb-2">💥 Expected Impact:</h5>
                        <p className="text-teal-200 text-sm">{rec.impact}</p>
                      </div>
              ...
              {activeTab === 'prompts' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-teal-600/20 to-blue-600/20 p-6 rounded-xl border border-teal-400/30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-teal-200 text-sm mb-4">{analysisReport.promptEngineering.llmOptimization.modelSelection}</p>
                      ...
                      <div>
                        ...
                        <p className="text-teal-200 text-sm">{analysisReport.promptEngineering.llmOptimization.contextStrategy}</p>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === 'context' && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-r from-teal-600/20 to-pink-600/20 p-6 rounded-xl border border-teal-400/30">
                      <h4 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Eye className="text-teal-400" />
                        Context Window Strategy
                      </h4>
                      <div className="space-y-4">
                        <div>
                          <h5 className="font-bold text-purple-300 mb-2">Strategy:</h5>
                          <p className="text-teal-200 text-sm">{analysisReport.contextEngineering.contextWindow.strategy}</p>
                        </div>
                        <div>
                          <h5 className="font-bold text-purple-300 mb-2">Chunking:</h5>
                          <p className="text-teal-200 text-sm">{analysisReport.contextEngineering.contextWindow.chunking}</p>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-1">
                            {analysisReport.contextEngineering.contextWindow.prioritization.map((priority, idx) => (
                              <li key={idx} className="text-teal-200 text-sm flex items-start gap-2">
                    ...
                    <div className="bg-gradient-to-r from-pink-500/20 to-teal-600/20 p-6 rounded-xl border border-pink-400/30">
                      <h4 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-pink-200 text-sm">{analysisReport.contextEngineering.memoryManagement.shortTerm}</p>
                        </div>
                        <div>
                          <h5 className="font-bold text-indigo-300 mb-2">Long-term Memory:</h5>
                          <p className="text-pink-200 text-sm">{analysisReport.contextEngineering.memoryManagement.longTerm}</p>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-2">
                            {analysisReport.contextEngineering.memoryManagement.contextRetention.map((retention, idx) => (
                              <li key={idx} className="text-pink-200 text-sm flex items-start gap-2">
                                <CheckCircle size={12} className="text-pink-400 mt-1 flex-shrink-0" />
                                {retention}
                              </li>
                            ))}
                          </ul>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-6">
                    {analysisReport.executionPlan.phases.map((phase, idx) => (
                      <div key={idx} className="bg-gradient-to-r from-blue-600/10 to-teal-600/10 p-6 rounded-xl border border-blue-400/30">
                        <div className="flex items-start gap-4 mb-4">
                          <div className="bg-gradient-to-r from-blue-500 to-teal-500 text-white rounded-full w-12 h-12 flex items-center justify-center text-lg font-bold flex-shrink-0">
                            {phase.phase}
                          </div>
                          ...
                          <div>
                            ...
                            <ul className="space-y-2">
                              {phase.dependencies.map((dep, depIdx) => (
                                <li key={depIdx} className="text-teal-200 text-sm flex items-start gap-2">
                                  <ArrowRight size={12} className="text-teal-400 mt-1 flex-shrink-0" />
                                  {dep}
                                </li>
                              ))}
                            </ul>
