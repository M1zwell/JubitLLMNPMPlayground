    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-lg shadow border text-center">
          ...
          <div className="text-sm text-gray-600">LLM Models</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border text-center">
        ...
        <div className="bg-white p-4 rounded-lg shadow border text-center">
          ...
          <div className="text-sm text-gray-600">Workflow Items</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border text-center">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500">{model.quality_index || 'N/A'}</div>
                    </div>
                  </div>
                </div>
              ))
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-600">{pkg.description?.substring(0, 30)}...</p>
                    </div>
                    <div className="text-right">
                      <div className="text-xs text-green-600">{formatNumber(pkg.weekly_downloads || 0)}</div>
                      <div className="text-xs text-gray-500">⭐ {formatNumber(pkg.github_stars || 0)}</div>
                    </div>
                  </div>
                </div>
              ))
