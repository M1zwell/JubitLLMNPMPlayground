...
const NPMImportModal: React.FC<NPMImportModalProps> = ({ isOpen, onClose, onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-xl max-w-4xl w-full border border-gray-700 overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-50 to-green-50 p-4 border-b border-gray-700 flex items-center justify-between">
